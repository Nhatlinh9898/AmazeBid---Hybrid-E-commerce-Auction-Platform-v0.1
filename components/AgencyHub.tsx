...
const AgencyHub: React.FC<AgencyHubProps> = ({ isOpen, onClose, products, onImportProduct, currentUserId }) => {
  ...
  return (
    <div className="fixed inset-0 z-[250] flex items-center justify-center p-4">
      ...
      <div className="relative bg-[#f8fafc] w-full max-w-6xl h-[90vh] rounded-3xl shadow-2xl overflow-hidden flex flex-col animate-in zoom-in-95 border border-white/20">
        ...
        <div className="bg-[#131921] p-6 text-white flex justify-between items-center shrink-0">
            ...
            <button onClick={onClose} className="hover:bg-gray-800 p-2 rounded-full transition-all"><X size={24}/></button>
        </div>
            ...
            {activeTab === 'MARKETPLACE' && (
                <div className="animate-in slide-in-from-right-4">
                    <div className="mb-6 flex gap-4">
                        <div className="flex-1 bg-white p-2 rounded-xl border border-gray-200 flex items-center gap-3 shadow-sm">
                        ...
                        <button className="px-4 py-2 bg-white border border-gray-200 rounded-xl font-bold text-gray-600 flex items-center gap-2 hover:bg-gray-50">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {wholesaleProducts.length === 0 ? (
                            <div className="col-span-full text-center py-20 text-gray-400">
                                ...
                                <p>Không tìm thấy sản phẩm nào đang tuyển đại lý.</p>
                            </div>
                        ) : (
                            wholesaleProducts.map(product => (
                                <div key={product.id} className="bg-white rounded-2xl p-4 border border-gray-200 shadow-sm hover:border-purple-400 transition-all group flex flex-col">
                                    ...
                                    <div className="mt-auto border-t border-gray-100 pt-3 flex justify-between items-center">
                                        ...
                                        <button 
                                            ...
                                            className="bg-[#131921] text-white px-4 py-2 rounded-lg text-xs font-bold flex items-center gap-2 hover:bg-purple-600 transition-colors"
                                        >
            ...
            {activeTab === 'MY_AGENCY' && (
                <div className="animate-in slide-in-from-right-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        ...
                        <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <span className="text-sm font-bold text-gray-500">Tổng Đại lý</span>
                            </div>
                        ...
                        <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <span className="text-sm font-bold text-gray-500">Sản phẩm đang tuyển sỉ</span>
                            </div>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                                ...
                                <div key={i} className="flex items-center justify-between p-3 bg-gray-50 rounded-xl border border-gray-100">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500">Đã bán: {100 - i*10} đơn</p>
                                        </div>
                                    </div>
                        ...
                        <button className="w-full mt-4 py-3 text-sm font-bold text-gray-500 hover:bg-gray-100 rounded-xl transition-colors flex items-center justify-center gap-1">
                            Xem tất cả báo cáo <ArrowRight size={14}/>
                        </button>
                    </div>
                </div>
            )}
